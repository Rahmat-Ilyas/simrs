...
$_SESSION["judul"] = "Tambah Paramedik";
    ...
    <div class="col-12">
        <div class="page-title-box">
            ...
            <ol class="breadcrumb float-right">
                ...
                <li class="breadcrumb-item active">Tambah Paramedik</li>
            </ol>
...
<div class="row">
    <div class="col-12">
        <div class="card-box">
            <h4 class="m-t-0 header-title">Tambah Paramedik</h4><br>
                    ...
                    <div class="p-20">
                        <form class="form-horizontal" role="form" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10">
                                    <input type="text" class="form-control" value="" name="spesialis">
                                </div>
                            </div>
