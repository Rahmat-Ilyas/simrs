...
$_SESSION["judul"] = "Edit Barang Pelayanan";
...
$id = $_GET["id"];
$barang = mysqli_query($conn,"SELECT * from tb_barang_pelayanan WHERE id=$id");
...
if (isset($_POST["submit"])) {
    ...
    $query= "UPDATE tb_barang_pelayanan SET nama_barang='$nama_barang', jumlah='$jumlah' WHERE id =$id";
...
<div class="row">
    <div class="col-12">
        <div class="card-box">
            <h4 class="m-t-0 header-title">Edit Barang Pelayanan</h4><br>
