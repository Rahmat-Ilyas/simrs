...
$_SESSION["judul"] = "Tambah Barang Kantor";
...
if (isset($_POST["submit"])){
    ...
    mysqli_query($conn, "INSERT INTO tb_barang_kantor VALUES ('', '$nama_barang', '$jumlah')");
...
<div class="row">
    <div class="col-12">
        <div class="card-box">
            <h4 class="m-t-0 header-title">Tambah Barang Kantor</h4><br>
