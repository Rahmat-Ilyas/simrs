...
$no_reg = mysqli_fetch_assoc($data);
                    ...
                    <div class="col-12">
                        <div class="p-20">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input type="text" class="form-control" value="<?= $no_reg['id'] ?>" name="no_registrasi" id="no_reg" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input type="text" class="form-control" value="" name="no_rawat" id="no_rawat" required>
                                </div>
                            </div>
